      ...
      <main className="pt-32 md:pt-40 pb-24 md:pb-32">
        <section className="relative">
          ...
          <div className="container-x relative">
            ...
            <div className="label mb-4">{'// política de privacidad — workspace'}</div>
            <h1 className="display-xl text-[2.15rem] sm:text-5xl md:text-6xl text-white max-w-4xl leading-[1.04]">
              Cómo tratamos los <span className="kw-mark">datos</span> en Tricode Workspace.
            </h1>
            <p className="mt-6 text-white/62 max-w-2xl text-base md:text-lg">
              Tricode Workspace es una herramienta de uso interno del equipo de Tricode. Esta página
              describe qué información recopila la app para Android y la plataforma que la acompaña.
            </p>
